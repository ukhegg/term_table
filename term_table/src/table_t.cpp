...
namespace term_table {
    ...
    size_t table_t::min_width() {
        return 0;
    }

    size_t table_t::min_height() {
        return 0;
    }

    size_t table_t::width() {
        return 0;
    }

    size_t table_t::height() {
        return 0;
    }

    size_t table_t::max_width() {
        return 0;
    }

    size_t table_t::max_height() {
        return 0;
    }

    void table_t::draw(i_canvas_area &canvas) {
